...
public class ClientServiceImpl implements ClientService {
     ...
     * @return                  Retorna ClientDTO do Client salvo no banco de dados.
     */
    @Override
    @Transactional
     ...
     * @return                  Retorna CLientDTO do Client atualizado, caso não encontre lança a exceção @ResourceNotFoundException.
     */
     ...
     * @return                  Retorna ClientDTO do Client encontrado no banco de dados.
     */
    @Override
    @Transactional
